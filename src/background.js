...
if (isChrome) {
    ...
    chrome.declarativeNetRequest.updateDynamicRules({
        ...
        },
        {
            ...
            'action': {
                'type': 'redirect',
                'redirect': {
                    url: "https://raw.githubusercontent.com/V1RU513N/PasDargentsPourLesVod/master/src/amazon-ivs-worker.min.js"
                }
            },
            'condition': {
    ...
    browser.webRequest.onBeforeRequest.addListener((details) => {
        return { redirectUrl: "https://raw.githubusercontent.com/V1RU513N/PasDargentsPourLesVod/master/src/amazon-ivs-worker.min.js" };
    },
        {
    ...
    browser.webRequest.onHeadersReceived.addListener((details) => {
        ...
        { urls: ["https://raw.githubusercontent.com/V1RU513N/PasDargentsPourLesVod/master/src/amazon-ivs-worker.min.js"] },

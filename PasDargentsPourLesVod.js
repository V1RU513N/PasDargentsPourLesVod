...
// const TAG = '[PasDargentsPourLesVod]'
...
const TAG = '[PasDargentsPourLesVod]';
const LOCAL_STORAGE_TAG = '@vod-PasDargentsPourLesVod-';
...
const createPlayer = (url) => {
    ...
    Array.from(twitchPlayerElements).forEach((el) => {
        ...
        el.setAttribute('vod-PasDargentsPourLesVod-hidden', 'true');
    });
    // Create vodPlayer
...
const src_TAG = '[PasDargentsPourLesVod]';
...
(function hijackFetch() {
    if (window.__PasDargentsPourLesVod_fetch) {
        return;
    }
                    ...
                    try {
                        ...
                        if (!canPlay) {
                            ...
                            try {
                                ...
                                window.__PasDargentsPourLesVod_needReset = true;
                            }
                            catch (_a) {
    ...
    window.__PasDargentsPourLesVod_fetch = true;
})();
(function hijackHistoryState() {
    if (window.__PasDargentsPourLesVod_history) {
        return;
    }
    const sameVodPage = () => window.location.pathname.startsWith(`/videos/${window.vodID}`);
    const resetIfNeeded = () => {
        if (!window.__PasDargentsPourLesVod_needReset) {
            return;
        }
    ...
    window.__PasDargentsPourLesVod_history = true;
})();
